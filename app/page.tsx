          ...
          <div className="header-actions">
            <div className="icon-button">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M2.5 5H17.5L16.25 16.25H3.75L2.5 5Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M7.5 8.75V5C7.5 3.62 8.62 2.5 10 2.5C11.38 2.5 12.5 3.62 12.5 5V8.75"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="icon-button">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                />
                <path
                  d="M3.75 17.5C3.75 14.5 6.5 12.5 10 12.5C13.5 12.5 16.25 14.5 16.25 17.5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <div className="about-promise-container">
          <div className="about-promise-content">
            ...
            <p className="promise-description">
              Shop curated collections from trusted mall brands — real inventory, real-time. Fast
              delivery, editorial polish, zero compromise.
            </p>
          </div>
          ...
          <div className="how-cards">
            <div className="how-card">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Tap brands you trust. Klypp connects to real-time stock across premium mall stores
                  so what you see is what is available — no guesswork, no sold-out surprises.
                </p>
              </div>
            ...
            <div className="how-card how-card-featured">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Choose sizes, styling notes, and add recommended complements. Our curated checkout
                  groups items by store for fast processing and crystal-clear updates.
                </p>
              </div>
              <div className="card-image">
                <img
                  src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=800&h=400&fit=crop&auto=format&q=80"
            ...
            <div className="how-card">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  A dedicated runner picks up from the store and delivers in under an hour — track
                  every step with live ETAs and photo confirmation for a luxe, seamless finish.
                </p>
              </div>
              <div className="card-image">
                <img
                  src="/images/gemini_delivery.png"
                  alt="Delivery person carrying parcel"
                />
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="footer-bottom">
            <p className="footer-copyright">
              &copy; 2025 Klypp. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
