            ...
            <div className="how-card">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Tap brands you trust. Klypp connects to real-time stock across premium mall stores so what you see is what is available — no guesswork, no sold-out surprises.
                </p>
              </div>
